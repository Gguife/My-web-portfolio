        ...
        <div className="contact-content">
          ...
          <div className="contact-info">
            <div className="contact-card">
              <MdOutgoingMail className='contact-card-icon'/>

              <h3 className="contact-card-title">Email</h3>
              <span className='contact-card-data'>gguife747@gmail.com</span>

              <a href="mailto:gguife747@gmail.com" className="contact-button">Fale comigo{""} <AiOutlineArrowRight className='contact-button-icon'/></a>
            </div>

            <div className="contact-card">
              <AiOutlineWhatsApp className='contact-card-icon'/>

              <h3 className="contact-card-title">Whatsapp</h3>
              <span className='contact-card-data'>+55 (12)98188-5646</span>
            ...
            <div className="contact-card">
              ...
              <span className='contact-card-data'>Guilherme Gomes</span>

              <a href="https://m.me/profile.php?id=100011448122810" className="contact-button">Fale comigo <AiOutlineArrowRight className='contact-button-icon'/></a>
            </div>
          </div>
        </div>

        <div className="contact-content">
          <h3 className="contact-title">Me envie um Email</h3>
